...
admin_sidebar = sidebar(
    sidebar_link(text="admin", href="/", icon="bar_chart_3"),
    sidebar_link(text="Usuarios", href="/usuarios", icon="users"),
    sidebar_link(text="Notas", href="/notas", icon="settings"),
    logo_src="/logo.jpg",
    heading="UIDE",
)
